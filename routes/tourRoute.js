...
// This is a nested route for reviews in tour route (tour/:tourId/reviews)
tourRouter.use('/:tourId/reviews', reviewRouter);

tourRouter.route('/top-5-cheap').get(tourController.aliasTopTours, tourController.getAllTours);
tourRouter.route('/monthly-plan/:year').get(authController.isLoggedIn, authController.restrictTo('admin', 'lead-guide'), tourController.getMonthlyPlan);
