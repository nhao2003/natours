...
const createSendToken = (user, statusCode, res) => {
    ...
    const cookieOptions = {
        ...
        // secure: true, // only send cookie on encrypted connection (https)
...
exports.login = catchAsync(async (req, res, next) => {
    ...
    // +password means that we are selecting the password field which is not selected by default
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    if (!currentPassword || !newPassword || !newPasswordConfirm) {
        return next(new AppError('Please provide currentPassword, newPassword and newPasswordConfirm!', 400));
    }
